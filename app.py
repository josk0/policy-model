...
model_params = {
    "num_agents": Slider("Number of Agents", 100, 20, 700, 10),
    "privileged_fraction": Slider("Privileged Fraction", 0.2, 0.05, 0.3, 0.05),
    "marginalized_fraction": Slider("Marginalized Fraction", 0.4, 0.1, 0.5, 0.05),
    "rel_policy_expansion": Slider("Policy Expansion Rate", 0.03, 0.0, 0.1, 0.01),
    "policy_impact_bias_pro_marginalized": Slider("Policy Bias", 0.7, 0.0, 1.0, 0.05),
